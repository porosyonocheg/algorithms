...
public class HardSortingTests {
    ...
    public void bucketSort() {
        ...
        nums = ArrayFactory.getRandomValueLimitedArray(50);
        result = nums.clone();
        compareSortMethodWithUtilArraysSort(new BucketSort(nums), result); // OutOfMemory для больших значений массива
        assertArrayEquals(result, nums);
...
//        assertArrayEquals(result, nums);
        ...
        nums = ArrayFactory.getRandomValueLimitedArray(5000);
        result = nums.clone();
        compareSortMethodWithUtilArraysSort(new BucketSort(nums), result);
        assertArrayEquals(result, nums);
...
//        assertArrayEquals(result, nums);
        ...
        nums = ArrayFactory.getRandomValueLimitedArray(500000);
        result = nums.clone();
        compareSortMethodWithUtilArraysSort(new BucketSort(nums), result);
        assertArrayEquals(result, nums);
